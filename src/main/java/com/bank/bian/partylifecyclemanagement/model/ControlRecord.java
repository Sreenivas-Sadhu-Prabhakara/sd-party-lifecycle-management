package com.bank.bian.partylifecyclemanagement.model;
...
/**
 * The BIAN control record for this service domain: "Party Record Management Plan".
 *
 ...
 * to its asset type (Party Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Party Record Management Plan";
